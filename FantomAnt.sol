    ...
    ERC2981PerTokenRoyalties
{
  ...
  */
    function mint(uint256 _mintAmount) public payable {
        ...
        require(
            ...
            "ERROR: You cant mint that many ants"
        );
        ...
        require(
            ...
            "ERROR: Not enough ants left to mint!"
        );
  ...
  */
    ...
    */
    function sendAllBalance() public payable onlySignatories {
...
//REVIEW RAND FUNCTION!!! (dario)
    ...
    */
    ...
    @description - Casts a vote if you own a ant
    ...
    */
    function castVote(string memory option) public {
        ...
        require(
            noVotes > 0,
            "ERROR: You have no voting rights. Get yourself a ant my fren!"
        );
